...
require (
	...
	github.com/axiomis-labs/metrics v0.0.10 // indirect
...
replace (
	...
	github.com/cometbft/cometbft => github.com/axiomis-labs/cometbft v1.0.1-axm.3
	github.com/cometbft/cometbft/api => github.com/axiomis-labs/cometbft/api v1.0.0-axm.2
)
