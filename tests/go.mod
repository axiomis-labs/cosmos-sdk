...
require (
	...
	github.com/axiomis-labs/metrics/v2 v2.0.0-beta.8 // indirect
...
replace (
	...
	github.com/cometbft/cometbft => github.com/axiomis-labs/cometbft v1.0.1-axm.7
	github.com/cometbft/cometbft/api => github.com/axiomis-labs/cometbft/api v1.0.0-axm.3
)
